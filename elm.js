...
var $author$project$Page$footer = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href('https://github.com/wolfadex')
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href('https://twitter.com/wolfadex')
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href('https://www.linkedin.com/in/twolfgangschuster/')
				]),
			_List_fromArray(
				[
...
var $author$project$Page$header = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('The Toolshed'),
					A2(
					$elm$html$Html$img,
					_List_fromArray(
						[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Musings on web development tools')
				]))
		]));
...
var $author$project$Post$metaSpacer = A2(
	$elm$html$Html$span,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Post$tagsToHtml = function (tags) {
	...
	return A2(
		...
		$author$project$Post$metaSpacer,
		A2($elm$core$List$map, linkify, tags));
};
